...
/// Theme toggle: [GestureDetector] + [Semantics] only (no [IconButton], no
/// [Tooltip] / RawTooltip). Avoids GlobalKey / ink-renderer issues beside
/// [PageView] and other scrollables.
